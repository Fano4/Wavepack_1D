...
#${icpp} -O0 -Wall -g -qopenmp -I/${GSL_ROOT}/include -I/${MKLROOT}include -I/${HF5_ROOT}/include -I/${PWAPIC_ROOT}/photoionization_module_1.0 -L/${HF5_ROOT}/lib /${HF5_ROOT}/lib/libhdf5_hl_cpp.a /${HF5_ROOT}/lib/libhdf5_cpp.a -L/${GSL_ROOT}/lib -L/${MKLROOT}lib/intel64  -L/${PWAPIC_ROOT}/photoionization_module_1.0 -Wl,-rpath -Wl,/${HF5_ROOT}/lib -mkl -lgsl -liomp5 -lhdf5 -lhdf5_cpp -lpthread -ldl -lrt -lz -DMKL_Complex16="std::complex<double>" ${DIRECTORY}/wavepack_1d.cpp -o ${DIRECTORY}/test_compile.exe
