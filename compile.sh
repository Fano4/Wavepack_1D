...
icpp=/opt/intel/composer_xe_2015.3.187/bin/intel64/icpc
${icpp} -O3 -g -qopenmp -I/${MKLROOT}include -I/${MKLROOT}include/fftw -I/${HF5_ROOT}/include -I/${PICE_ROOT} -L/${HF5_ROOT}/lib /${HF5_ROOT}/lib/libhdf5_hl_cpp.a /${HF5_ROOT}/lib/libhdf5_cpp.a /${HF5_ROOT}/lib/libhdf5_hl.a /${HF5_ROOT}/lib/libhdf5.a -L/${MKLROOT}lib/intel64 -L/${PICE_ROOT} -Wl,-rpath -Wl,/${HF5_ROOT}/lib -mkl -liomp5 -lhdf5 -lhdf5_cpp -lrt -ldl -lpthread -DMKL_Complex16="std::complex<double>" ${DIRECTORY}/wavepack_1d.cpp -o ${DIRECTORY}/wavepack.exe
